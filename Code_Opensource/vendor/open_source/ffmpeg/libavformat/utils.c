...
{
    return hw_avformat_find_stream_info(ic, options, 0);
}

int hw_avformat_find_stream_info(AVFormatContext *ic, AVDictionary **options, int tryDecodeNumber)
{
...
FF_ENABLE_DEPRECATION_WARNINGS
    ...
    for (int k3_count = 0; k3_count < tryDecodeNumber; k3_count++) {
        const AVPacket *pkt;
