...
extern int fsck_chk_didnode_blk(struct f2fs_sb_info *, struct f2fs_inode *,
		enum FILE_TYPE, struct f2fs_node *, u32 *, struct child_info *,
		struct dnode_of_data *);
extern int fsck_chk_data_blk(struct f2fs_sb_info *, u32, struct child_info *,
		int, enum FILE_TYPE, u32, u16, u8, int, struct dnode_of_data *);
extern int fsck_chk_dentry_blk(struct f2fs_sb_info *, u32, struct child_info *,
		int, int, struct dnode_of_data *);
...
extern void set_free(struct f2fs_sb_info *, unsigned int);
extern int is_valid_summary(struct f2fs_sb_info *,
				struct f2fs_summary *, u32);
...
extern int find_next_free_block(struct f2fs_sb_info *, u64 *,
		int, int,  struct f2fs_summary *);
extern void write_checkpoints(struct f2fs_sb_info *);
extern void fix_checkpoint(struct f2fs_sb_info *);
...
extern void reset_curseg(struct f2fs_sb_info *sbi, int type);
...
/* segment.c */
void write_inode(struct f2fs_sb_info *, u64, struct f2fs_node *);
int reserve_new_block(struct f2fs_sb_info *, block_t *,
					struct f2fs_summary *, int, bool);
block_t next_free_blkaddr(struct f2fs_sb_info *, int);
int f2fs_write_data_block(struct f2fs_sb_info *, void *,
		block_t, struct dnode_of_data *, int);
...
int f2fs_write_node_block(struct f2fs_sb_info *sbi,
			struct f2fs_node *node_blk, block_t blk_addr);
