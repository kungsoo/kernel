...
export product_type := 
export chip_type := 
export CFG_PLATFORM := kirin980
export OBB_PRODUCT_NAME := kirin980
...
ifeq ($(BUILD_WITH_AQ), true)
    ...
    KBUILD_CFLAGS += -DCONFIG_PROC_CMDLINE_READ_AQ
...
ifeq ($(BUILD_WITH_AQ_HM4),true)
    $(warning BUILD_WITH_AQ_HM4=$(BUILD_WITH_AQ_HM4))
    KBUILD_CFLAGS += -DCONFIG_RMAP_TRYLOCK
    KBUILD_CFLAGS += -DCONFIG_OPTIMIZE_MM_AQ_HM4
    KBUILD_CFLAGS += -DCONFIG_SCHED_DEADLINE_DISABLE
    KBUILD_CFLAGS += -DCONFIG_ADJUST_SWAPPINESS
    KBUILD_CFLAGS += -DCONFIG_SPLIT_SHRINKER
    KBUILD_CFLAGS += -DCONFIG_STOP_PAGE_REF
    KBUILD_CFLAGS += -DCONFIG_DFX_LOCK_TRACE
    KBUILD_CFLAGS += -DCONFIG_SCHED_CFS_WORKAROUND
ifeq (${TARGET_BUILD_VARIANT}, eng)
export TARGET_BUILD_VARIANT
    KBUILD_CFLAGS += -DCONFIG_KSWAPD_DEBUG
    KBUILD_CFLAGS += -DCONFIG_SPLIT_SHRINKER_DEBUG
    KBUILD_CFLAGS += -DCONFIG_STOP_PAGE_REF_DEBUG
    KBUILD_CFLAGS += -DCONFIG_DFX_LOCK_TRACE_DEBUG
endif
endif
