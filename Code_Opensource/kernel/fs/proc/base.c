...
#if defined(CONFIG_HW_VIP_THREAD) && defined(CONFIG_HARMONY_PERFORMANCE_AQ)
#define AVAILABLE_VIP		0x11
#endif
				     ...
				     size_t _count, loff_t *pos)
{
	...
	char c;
	ssize_t rv;
#ifdef CONFIG_PROC_CMDLINE_READ_AQ
	pid_t target_pid;
#endif
			     ...
			     size_t count, loff_t *ppos)
{
	...
	int tmp_vip = static_vip & AVAILABLE_VIP;
	task->static_vip = (tmp_vip != 0) ? tmp_vip : 0;
#else
...
#if !defined(CONFIG_ARCH_HISI) || defined(CONFIG_HW_TIMERSLACK_FAST)
