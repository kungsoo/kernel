...
#define SYS_AO_CODE_SEC_SIZE_MAX 0x87D0
#define SYS_CODE_SEC_SIZE_MAX 0x17F24
#define SYS_BSS_SEC_SIZE_MAX 0x381C
#define SYS_DATA_SEC_SIZE_MAX 0x1000
...
#define PERI_AVS_PARA_SIZE (0xF0)
...
#if ((SYS_AO_CODE_SEC_BASE + SYS_AO_CODE_SEC_SIZE + SYS_AO_CODE_SEC_RESERVED_SIZE) > (M3_SRAM_BASE + M3_SRAM_AO_SIZE))
    #pragma message(PRINT_MACRO(SYS_AO_CODE_SEC_BASE + SYS_AO_CODE_SEC_SIZE + SYS_AO_CODE_SEC_RESERVED_SIZE))
