...
#endif
#define HISI_RESERVED_FASTBOOT_STACK_BASE (0x3A8C0000)
...
#define HISI_RESERVED_FASTBOOT_GCOV_STACK_BASE (0x3ABC0000)
#define HISI_RESERVED_FASTBOOT_GCOV_HEAP_CACHE_BASE (0x3AD00000)
...
#define ATF_RESERVED_BL31_PHYMEM_BASE 0x12200000
...
#define HISI_RESERVED_VOICEID_PHYMEM_BASE 0x15C80000
#define HISI_RESERVED_VOICEID_PHYMEM_SIZE (0x500000)
#define HISI_RESERVED_TD_FACE_DETECT_PHYMEM_BASE 0x16180000
#define HISI_RESERVED_TD_FACE_DETECT_PHYMEM_SIZE (0x3900000)
#define HISI_RESERVED_SENSORHUB_AOD_PHYMEM_BASE 0x19C00000
#define HISI_RESERVED_SENSORHUB_AOD_PHYMEM_SIZE (0x300000)
#define HISI_RESERVED_MODEM_LR_RO_BASE 0x20000000
#define HISI_RESERVED_MODEM_LR_RO_SIZE (0x2C00000)
#define HISI_RESERVED_MODEM_LR_RW_BASE 0x22C00000
#define HISI_RESERVED_MODEM_LR_RW_SIZE (0x9080000)
...
#define RESERVED_DMSS_REGS_BACKUP_BASE 0x2CDF0000
...
#define HISI_RESERVED_SUPERSONIC_PHYMEM_BASE 0x2F900000
#define HISI_RESERVED_SUPERSONIC_PHYMEM_SIZE 0x1630000
#define HISI_RESERVED_FINGERPRINT_BASE 0x30F30000
...
#endif
#if defined(CONFIG_GCOV_XLOADER) || defined(CONFIG_HISI_GCOV_FASTBOOT)
...
#define HISI_RESERVED_SLT_HIBENCH_GCDA_PHYMEM_BASE (0xBA200000)
#define HISI_RESERVED_SLT_HIBENCH_GCDA_PHYMEM_SIZE (0x100000)
#endif
#define HISI_RESERVED_HOTA_PHYMEM_BASE (0xAA200000)
