...
#define HX32062SE_PARA_SIZE                 30
#define SIP3510_PARA_SIZE                   30 // must >= ARR_SIZE(sip3510_spectral_param) in vendor/huawei/extra/sensor/sensorhub/mcu/include/driver/sip3510.h
...
struct sar_aw9610_calibrate_data {
	uint16_t offset;
	uint16_t diff;
};
...
union sar_calibrate_data {
	...
	struct sar_aw9610_calibrate_data aw9610_cali_data;
};
...
typedef struct _bu27006_als_para_table {
	...
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	s16 bu27006_para[27]; /* give to bu27006 rgb sensor use,output lux and cct will use these para */
} bu27006_als_para_table;
...
typedef struct _tcs3707_als_para_table {
	...
	uint8_t tp_lcd_manufacture;
	uint8_t tp_color;
	s16 tcs3707_para[29]; /* give to tcs3707 rgb sensor use,output lux and cct will use these para */
...
typedef struct _hx32062se_ps_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_manufacture;
	uint8_t tp_color;
	s16 ps_para[HX32062SE_PARA_SIZE]; /* modify the size of the array to pass more data */
} hx32062se_ps_para_table;
typedef struct _hx32062se_als_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_manufacture;
	uint8_t tp_color;
	float als_para[HX32062SE_PARA_SIZE]; /* modify the size of the array to pass more data */
} hx32062se_als_para_table; /* keep als_para size smaller than SENSOR_PLATFORM_EXTEND_DATA_SIZE */
typedef struct _sip3510_ps_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_manufacture;
	uint8_t tp_color;
	s16 ps_para[SIP3510_PARA_SIZE]; /* modify the size of the array to pass more data */
} sip3510_ps_para_table;
typedef struct _sip3510_als_para_table {
	uint8_t phone_type;
	uint8_t phone_version;
	uint8_t tp_manufacture;
	uint8_t tp_color;
	float als_para[SIP3510_PARA_SIZE]; /* modify the size of the array to pass more data */
} sip3510_als_para_table; /* keep als_para size smaller than SENSOR_PLATFORM_EXTEND_DATA_SIZE */
...
extern int write_calibrate_data_to_nv(int nv_number, int nv_size, const char *nv_name, const char *temp);
