	...
	const char *chip_info)
{
	...
	else if (!strncmp(chip_info, "als_s005_001",
		sizeof("als_s005_001")))
		dev_info->chip_type = ALS_CHIP_BU27006;
	else
		return -1;
...
static int als_sip_detect(struct als_device_info *dev_info,
	const char *chip_info)
{
	if (!strncmp(chip_info, "als,als_s008_001",
		sizeof("als,als_s008_001")))
...
static int als_hx_detect(struct als_device_info *dev_info,
	const char *chip_info)
{
	if (!strncmp(chip_info, "als,als_s009_001",
		sizeof("als,als_s009_001")))
