...
#define DELAY_5000MS 6000
#define CHARGER_10V2P25A 9
#define CHARGER_5V4P5A 2
#define CHARGER_10V4A 3
#define CHARGER_10V2A 4
#define CHARGER_11V6A 11
#define UNPLUG_CHARGER 4
#define GET_CHARGER_CNT 5
#define MAX_INDEX 3
...
void get_current_charger_type(void)
{
	...
	for (count = GET_CHARGER_CNT; count > 0; count--) {
		if (charge_get_charger_online()) {
			...
			if (ada_type == CHARGER_10V2P25A || ada_type == CHARGER_10V4A || ada_type == CHARGER_10V2A || ada_type == CHARGER_11V6A)
