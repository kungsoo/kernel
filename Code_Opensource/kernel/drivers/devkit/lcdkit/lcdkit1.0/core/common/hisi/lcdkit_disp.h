...
#define ALPM_HYBRID_CMD 4
#define ALPM_HYBRID_EXIT_CMD 5
#define AOD_EXIT_CMD 0
#define AOD_WATCH_NORMAL_BRIGHTNESS 1
#define AOD_SEND_FRAME_CMD 2
#define AOD_WATCH_LOW_BRIGHTNESS 3
#define AOD_WATCH_ULTRA_LOW_BRIGHTNESS 6
...
/*
 * gesture mode gpio reset
 */

static struct gpio_desc lcdkit_tp_rst_gesture_low_cmds[] =
{
	/* tp reset low */
	{
...
static struct gpio_desc lcdkit_lcd_rst_gesture_low_cmds[] =
{
	/* lcd reset low */
	{
		DTYPE_GPIO_OUTPUT, WAIT_TYPE_MS, 5,
...
static struct gpio_desc lcdkit_tp_lcd_rst_gesture_high_cmds[] =
{
	/* tp reset high */
	{
...
static struct gpio_desc lcdkit_tp_lcd_rst_gesture_hlh_cmds[] =
{
	/* tp reset low */
	{
		DTYPE_GPIO_OUTPUT, WAIT_TYPE_MS, 5,
