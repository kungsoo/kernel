...
void lcdkit_parse_panel_dts(struct device_node* np)
{
	...
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-mipi-switch-support", &lcdkit_info.panel_infos.mipi_switch_support, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-mipi-switch-support", &lcdkit_info.panel_infos.mipi_aod_esd_switch, 0);
	...
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-panel-ts-control-lcd-reset-support",
	...
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-watch-aod", &lcdkit_info.panel_infos.watch_aod, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-watch-aod-hybrid", &lcdkit_info.panel_infos.watch_aod_hybrid, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-watch-aod-normal-brightness", &lcdkit_info.panel_infos.watch_aod_normal_brightness, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-watch-aod-low-brightness", &lcdkit_info.panel_infos.watch_aod_low_brightness, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-watch-aod-ultralow-brightness", &lcdkit_info.panel_infos.watch_aod_ultralow_brightness, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-tddi-aod", &lcdkit_info.panel_infos.tddi_aod, 0);
	OF_PROPERTY_READ_U32_DEFAULT(np, "hw,lcdkit-tddi-aod-high-light", &lcdkit_info.panel_infos.tddi_aod_high_light, 0);
	OF_PROPERTY_READ_U32_DEFAULT(np, "hw,lcdkit-tddi-aod-middle-light", &lcdkit_info.panel_infos.tddi_aod_middle_light, 0);
	OF_PROPERTY_READ_U32_DEFAULT(np, "hw,lcdkit-tddi-aod-low-light", &lcdkit_info.panel_infos.tddi_aod_low_light, 0);
	OF_PROPERTY_READ_U32_DEFAULT(np, "hw,lcdkit-tddi-aod-no-light", &lcdkit_info.panel_infos.tddi_aod_no_light, 0);
	OF_PROPERTY_READ_U32_DEFAULT(np, "hw,lcdkit-doze-time-delay", &lcdkit_info.panel_infos.doze_time_delay, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-ramless-aod", &lcdkit_info.panel_infos.ramless_aod, 0);
	...
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-dither-support", &lcdkit_info.panel_infos.dither_support, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-panel-new-version-support",
		&lcdkit_info.panel_infos.panel_version_support, 0);
	OF_PROPERTY_READ_U8_DEFAULT(np, "hw,lcdkit-panel-dsi-high-speed-support",
		&lcdkit_info.panel_infos.panel_highspeed_support, 0);
