...
struct lcdkit_panel_infos
{
	...
	u8 hbm_support;
	u8 mipi_switch_support;
	u8 mipi_aod_esd_switch;
	...
	u8 ts_control_lcd_reset_support;
	...
	u8 watch_aod_hybrid;
	u8 tddi_aod;
	uint32_t tddi_aod_high_light;
	uint32_t tddi_aod_middle_light;
	uint32_t tddi_aod_low_light;
	uint32_t tddi_aod_no_light;
	ktime_t alpm_start_time;
	uint32_t doze_time_delay;
