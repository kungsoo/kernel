...
static noinline int alloc_debug_processing(struct kmem_cache *s,
					struct page *page,
					void *object, unsigned long addr, unsigned int orig_size)
#else
static noinline int alloc_debug_processing(struct kmem_cache *s,
					struct page *page,
					void *object, unsigned long addr)
...
static inline int alloc_debug_processing(struct kmem_cache *s,
	struct page *page, void *object, unsigned long addr, unsigned int orig_size) { return 0; }
#else
static inline int alloc_debug_processing(struct kmem_cache *s,
...
#endif
{
	...
	unsigned int waste = (unsigned int)s->object_size - orig_size;
#endif
