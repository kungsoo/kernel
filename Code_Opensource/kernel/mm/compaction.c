...
/*
 * Disable proactive compaction when PERFORMANCE_AQ not work
 */
#ifndef CONFIG_HARMONY_PERFORMANCE_AQ
#undef CONFIG_COMPACTION_PROACTIVE
#undef CONFIG_HW_PROACTIVE_COMPACT
#endif
...
{
	if (pgdat->kswapd &&
		pgdat->kswapd->state  == TASK_RUNNING)
		return true;
	return false;
}
...
#endif
{
	...
	if (cc->proactive_compaction) {
		...
		trace_mm_compaction_kcompactd_score_update(pgdat->node_id, score, wmark_low);
#ifndef CONFIG_HARMONY_PERFORMANCE_AQ
