	...
	struct cpumask *cpus_allowed, int *cpu_id)
{
	...
	for (i = 0; i < nr_cpu_ids; i++) {
		if (i == src_cpu || !cpu_online(i) || cpu_isolated(i))
			continue;
