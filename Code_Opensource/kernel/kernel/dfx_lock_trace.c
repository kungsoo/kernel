...
extern void *get_kernfs_mutex(void);
...
void dump_lock_trace(unsigned long data)
{
...
DEFINE_TIMER(lock_timer, dump_lock_trace, TIMER_PERIOD * HZ, (unsigned long)&lock_timer);
