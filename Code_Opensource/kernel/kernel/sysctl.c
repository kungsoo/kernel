...
#if (defined CONFIG_HW_PROACTIVE_COMPACT) && (defined CONFIG_HARMONY_PERFORMANCE_AQ)
...
static struct ctl_table vm_table[] = {
...
#if (defined CONFIG_COMPACTION_PROACTIVE) && (defined CONFIG_HARMONY_PERFORMANCE_AQ)
	{
   ...
   (defined(CONFIG_SUPERH) && defined(CONFIG_VSYSCALL))
	...
	{
		.procname	= "free_swapcache_aggressively",
		.data		= &free_swapcache_aggressively,
		.maxlen		= sizeof(free_swapcache_aggressively),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
		.extra2		= &one,
...
#endif
	{
		.procname	= "only_do_global_shrink_slab",
		.data		= &only_do_gss,
		.maxlen		= sizeof(only_do_gss),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= &zero,
		.extra2		= &one,
